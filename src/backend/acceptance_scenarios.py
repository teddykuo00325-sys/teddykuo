...
PRODUCT_KB = {
    ...
    'microjet': {
        ...
        'faq': {
            ...
            # ═══ 擴充其他機型 KB（印表機型號涵蓋率 ≥ 95%）═══
            'MJ-2800 規格': (
                '【MJ-2800 入門工業噴印機】· MJ-3200 的前一代機型\n'
                '· 列印技術：熱泡式噴墨\n'
                '· 解析度：1200 × 1200 dpi\n'
                '· 速度：A4 28 ppm 黑白 / 22 ppm 彩色\n'
                '· 墨水：3 色（CMY）+ 獨立黑（MJ-INK-2800-K）\n'
                '· 連線：RJ45、Wi-Fi 5、USB 2.0\n'
                '· 電源：AC 100~240V 50/60Hz 最大 220W\n'
                '· 保固：2 年（同 MJ-3200）\n'
                '· 停產狀態：2024 年起停產，零件供應至 2029\n'
                '· 建議升級路徑：MJ-3200（速度 ×1.5 / 印頭壽命 ×2）'
            ),
            'MJ-3100 規格': (
                '【MJ-3100 輕型工業噴印機】· MJ-3200 同世代小尺寸機種\n'
                '· 適用：中小批量印刷、POD 按需印刷\n'
                '· 速度：A4 36 ppm 黑白 / 30 ppm 彩色（比 MJ-3200 略慢）\n'
                '· 墨水：4 色 CMYK，與 MJ-3200 共用墨水匣 MJ-INK-C/M/Y/K\n'
                '· 尺寸：W 520 × D 600 × H 380 mm（比 MJ-3200 小一號）\n'
                '· 保固：2 年，零件支援到 2028\n'
                '· 錯誤碼對照：與 MJ-3200 完全相同（E-041~E-999）\n'
                '· 韌體：獨立版本，最新 v1.92（注意與 MJ-3200 v2.x 不共用）'
            ),
            'MJ-4500 規格': (
                '【MJ-4500 大型生產級噴印機】· MJ-3200 的高階機型\n'
                '· 適用：大批量工業生產、包裝印刷\n'
                '· 解析度：2400 × 2400 dpi\n'
                '· 速度：A4 80 ppm 黑白 / 68 ppm 彩色\n'
                '· 墨水：6 色 CMYK + LC + LM（相片品質）\n'
                '· 連線：10GbE、光纖、USB 3.1\n'
                '· 重量：108 kg（需兩人搬運）\n'
                '· 電源：AC 200~240V 專線，最大 850W\n'
                '· 保固：3 年基本 + 可延長 2 年\n'
                '· 年度維護合約：標配（含噴頭 4 次校保 + 4h SLA）'
            ),
            '印表機型號對照': (
                '【MicroJet 工業噴印機全系列（2026 年現售）】\n'
                '┌────────┬──────────┬────────┬─────────┬──────┐\n'
                '│ 型號    │ 定位      │ 速度    │ 墨水色數 │ 狀態  │\n'
                '├────────┼──────────┼────────┼─────────┼──────┤\n'
                '│ MJ-2800 │ 入門       │ 28 ppm │ 3+1     │ 停產  │\n'
                '│ MJ-3100 │ 輕量工業   │ 36 ppm │ 4       │ 現售  │\n'
                '│ MJ-3200 │ 標準工業   │ 42 ppm │ 4       │ 現售⭐│\n'
                '│ MJ-4500 │ 生產級     │ 80 ppm │ 6       │ 現售  │\n'
                '└────────┴──────────┴────────┴─────────┴──────┘\n'
                '選型建議：\n'
                '· 單月印量 < 1 萬張 → MJ-3100\n'
                '· 單月 1~5 萬張 → MJ-3200（多數客戶首選）\n'
                '· 單月 > 5 萬張 → MJ-4500'
            ),
            '墨水匣規格（通用）': (
                '【MJ 系列墨水匣】\n'
                '· 標準墨水：MJ-INK-C/M/Y/K（500 ml，NT$6,800/匣）相容 MJ-3100 / MJ-3200\n'
                '· 高容量：MJ-INK-HC-C/M/Y/K（1000 ml，NT$12,800）僅相容 MJ-4500\n'
                '· 舊版墨水：MJ-INK-2800-K（黑 300 ml）MJ-2800 專用\n'
                '· 認證：MicroJet Cartridge Chip v3（MJ-3200/3100）/ v4（MJ-4500）\n'
                '· 保存：避光、15~28°C、未拆封 24 個月'
            ),
            '其他機型保固政策': (
                '【MJ 系列保固政策】\n'
                '· MJ-2800 / MJ-3100 / MJ-3200：主機 2 年，印頭 1 年或 5,000 萬點\n'
                '· MJ-4500：主機 3 年，印頭 2 年或 1 億點\n'
                '· 延保 MJ-WARR-PLUS：+3 年 NT$58,000（MJ-3200 專屬）\n'
                '· 延保 MJ-WARR-ULTRA：+2 年 NT$120,000（MJ-4500 專屬，含 4h 現場 SLA）'
            ),
        }
    }
}
